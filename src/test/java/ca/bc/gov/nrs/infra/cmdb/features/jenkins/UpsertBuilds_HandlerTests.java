...
//
//        MatcherAssert.assertThat(result.getAdded().size(), Matchers.is(1));
//    }
//
//    @Test
...
//        AddBuild.Model build = new AddBuild.Model();
//        build.setProjectKey("NPE");
//        build.setComponentName(component);
//        build.setNumber(number);
//        List<AddBuild.Model> builds = Arrays.asList(build);
//        UpsertBuilds.Command command = new UpsertBuilds.Command();
//        command.setBuilds(builds);
//
//        UpsertBuilds.Model result = this.sut.handle(command);
...
//        AddBuild.Model model = new AddBuild.Model();
...
//
//        MatcherAssert.assertThat(updatedBuild.isPresent(), Matchers.is(true));
//        MatcherAssert.assertThat(updatedBuild.get().getDisplayName(), Matchers.not(preExistingDisplayName));
//        MatcherAssert.assertThat(updatedBuild.get().getDisplayName(), Matchers.is(expectedDisplayName));
//    }
//}
