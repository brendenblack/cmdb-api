...
public class UpsertBuilds_Handler_MakeProjectMapTests
{
    ...
    {
        this.sut = new UpsertBuilds.Handler(mock(CmdbContext.class), mock(InfrastructureRegistrationService.class));
    }
    ...
    public void shouldCreateExpectedMap_whenListIsValid()
    {
        ...
        assertThat("An unexpected number of projects have been accounted for", result.keySet().size(), is(2));
        assertThat(result.get("A").size(), is(3));
